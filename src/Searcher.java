	...
	public static void main(String[] args) {
		...
		if (args.length <= 0)
			throw new IllegalArgumentException(
					"Searcher needs at least one argument specifying the term to search for. Optionally a second argument can be provided to specify a custom urls.txt file detailing the urls to search on");
